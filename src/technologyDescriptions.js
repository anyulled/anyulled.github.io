const technologyCatalog = {
  ...
  'error prone': ['Error Prone', 'Used as compile-time static analysis to detect common Java programming mistakes.'],
  ...
  'ibm db2': ['IBM Db2', 'Used as an enterprise relational database for integration testing and data persistence.'],
  ...
  'j2c': ['J2EE Connector Architecture (J2C)', 'Used to integrate Java services with enterprise information systems, including mainframe platforms.'],
  'j2ee connector architecture (j2c)': ['J2EE Connector Architecture (J2C)', 'Used to integrate Java services with enterprise information systems, including mainframe platforms.'],
  ...
  'javaserver faces (jsf)': ['JavaServer Faces (JSF)', 'Used as the server-side UI framework in the legacy Java application.'],
  ...
  'jspecify': ['JSpecify', 'Used to express nullness expectations in Java APIs and strengthen static analysis.'],
  ...
  'openrewrite': ['OpenRewrite', 'Used to apply automated refactoring and modernization recipes to Java code.'],
  ...
  'redis': ['Redis', 'Used as an in-memory data store and integration-test dependency for Java services.'],
  ...
  'spring security ': ['Spring Security', 'Used to secure Java applications and manage authentication and authorization.'],
  'spotbugs': ['SpotBugs', 'Used to detect potential bugs through static analysis of Java bytecode.'],
  'spotless': ['Spotless', 'Used to apply consistent source formatting in the Java build.'],
  ...
  'wiremock': ['WireMock', 'Used to emulate external HTTP integrations in automated tests.'],
